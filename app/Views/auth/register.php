        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    ...
                    <p class="text-lead text-white">Daftarkan akun anda pada aplikasi baseapp ini</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <input type="password" name="re-password" class="form-control <?= $validation->hasError('re-password') ? 'is-invalid' : '' ?>" placeholder="Re-Password" aria-label="Password" aria-describedby="password-addon">
                            <div class="invalid-feedback">
                        ...
                        <p class="text-sm mt-3 mb-0">Sudah mempunyai akun? <a href="<?= admin_url('auth') ?>" class="text-dark font-weight-bolder">Masuk</a></p>
                        <?= form_close() ?>
                    </div>
                </div>
            </div>
